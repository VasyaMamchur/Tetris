...
from figurines import Tetromino
...
class Text:
    ...
    def draw(self):
        ...
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.22),
                            text='next ', fgcolor='cyan',
                            size=TILE_SIZE * 1.4, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.57),
                            text='score', fgcolor='cyan',
                            size=TILE_SIZE * 1.4, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.7),
                            text=f'{self.app.tetris.score}', fgcolor='white',
                            size=TILE_SIZE * 1.8)
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.82),
                            text='P-pause ', fgcolor='orange',
                            size=TILE_SIZE * 0.8, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.87),
                            text='M-mute ', fgcolor='orange',
                            size=TILE_SIZE * 0.8, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.92),
                            text='R-restart ', fgcolor='orange',
                            size=TILE_SIZE * 0.8, bgcolor='black')
class Tetris:
    def __init__(self, app):
        self.app = app
